  ...
  return (
    <>
      <div className="contact-us-container row">
        <div className="blog-footer-1 col-md-6 col-xs-12">
          <div className=" blog-footer-1-content">
            ...
            <div className="row blog-fields">
              <div className="col-md-12 col-xs-12 field-1">Name</div>
              <div className="col-md-12 col-xs-12 field-2">Surname</div>
              <div className="col-md-12 col-xs-12 field-3">Email</div>
              <div className="col-md-12 col-xs-12 field-4">Subscribe Now</div>
            </div>
          </div>
        </div>
